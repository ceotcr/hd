...
import { signInSchema, type SignInData } from "@/libs/zod/Signin";
...
export default function SignInForm() {
    ...
    const onSubmit = async (data: SignInData) => {
        if (step === 1) {
            ...
            const response = await signIn("otp-signin", {
                ...data,
                redirect: false,
            });
        ...
        <div className="max-w-sm w-full mx-auto">
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="text-sm text-gray-500 mt-2 md:text-left">
                            {canResend ? (
                                <button
                                    ...
                                    className="text-blue-600 hover:text-blue-800 font-medium cursor-pointer disabled:opacity-50 transition underline underline-offset-2"
                                >
                ...
                <div className="mt-6">
                    ...
                    >
                        {isSubmitting ? "Processing..." : step === 1 ? "Get OTP" : "Sign In"}
                    </button>
                </div>
